...
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/1.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/2.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/3.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/4.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/5.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/6.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/7.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/8.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/9.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 3х5.5 +кровельные работы. Осоргино/10.jpg', class: 'item'}).appendTo('.items');
...
$('.wrap').css('display', 'flex');$('.wrap').children().css('display', 'flex');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/1.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/2.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/3.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/4.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/5.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/6.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/7.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/8.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/9.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/10.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/11.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/12.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/13.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/14.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/15.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/16.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/17.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/18.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/19.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 4,5х5 в лапу. Нагаево. Уфа/20.jpg", class: 'item'}).appendTo('.items');
$('.item').eq(0).siblings().hide();
...
$('.wrap').css('display', 'flex');$('.wrap').children().css('display', 'flex');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/1.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/2.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/3.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/4.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/5.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/6.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/7.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/8.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/9.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/10.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/20.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/21.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/22.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/23.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/24.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/25.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/26.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/27.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/28.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/29.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/30.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/31.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/32.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/33.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/34.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/35.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/36.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/37.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/38.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/39.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/40.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/41.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/42.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/43.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/44.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/45.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/46.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/47.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/48.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/49.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/50.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/51.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/52.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/53.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/54.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/55.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/56.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/57.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/58.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/59.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/60.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/61.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/62.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/63.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/64.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/65.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/66.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/67.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/68.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/69.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/70.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/71.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/72.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/73.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/74.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/75.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/76.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/77.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/78.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/79.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/80.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/81.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/82.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/83.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/84.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/85.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/86.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/87.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/88.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/89.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/90.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/91.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/92.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/93.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/94.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/95.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/96.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/97.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/98.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/99.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/100.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/101.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/102.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/103.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/104.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/105.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/106.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/107.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/108.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/109.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/110.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/111.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6,2на9,2 (1 этаж) 8,2на9,2 (2этаж)/112.jpg", class: 'item'}).appendTo('.items');
$('.item').eq(0).siblings().hide();
$('.item').click(function(){
$(this).next().hide().slideDown();
$(this).hide().slideUp();});
...
$('.wrap').css('display', 'flex');$('.wrap').children().css('display', 'flex');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/1.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/2.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/3.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/4.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/5.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/6.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/7.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/8.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/9.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/10.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/11.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/12.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/13.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/14.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/15.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6.30 на 9.70 Нижегородка/16.jpg", class: 'item'}).appendTo('.items');
$('.item').eq(0).siblings().hide();
$('.item').click(function(){$(this).next().hide().slideDown();$(this).hide().slideUp();});
$('.item').last().click(function(){$('.item').first().hide().slideDown();});
...
$('.wrap').css('display', 'flex');$('.wrap').children().css('display', 'flex');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/1.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/2.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/3.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: 'img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/4.jpg', class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/5.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/6.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/7.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/8.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/9.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/10.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/11.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/12.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/13.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/14.jpg", class: 'item'}).appendTo('.items');
$('<img>', { src: "img/Проекты/В лапу/Сруб 6х8 мансардный+кровля/15.jpg", class: 'item'}).appendTo('.items');
$('.item').eq(0).siblings().hide();
$('.item').click(function(){$(this).next().hide().slideDown();$(this).hide().slideUp();});
$('.item').last().click(function(){$('.item').first().hide().slideDown();});
